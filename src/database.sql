...
DROP TABLE IF EXISTS ENCARGADO_EMPLEADO;
...
CREATE TABLE ENCARGADO_EMPLEADO (
    DNI_ENCARGADO DNI_DOMAIN,
    DNI_EMPLEADO DNI_DOMAIN,
    PRIMARY KEY (DNI_ENCARGADO, DNI_EMPLEADO),
    FOREIGN KEY (DNI_ENCARGADO) REFERENCES ENCARGADO(DNI) ON DELETE CASCADE,
...
CREATE TABLE PLAN_ACTIVIDAD (
    ...
    FOREIGN KEY (ID_PLAN) REFERENCES PLAN(ID) ON DELETE CASCADE,
...
CREATE TABLE LIMPIADOR_SALA (
    ...
    FOREIGN KEY (NUMERO) REFERENCES SALA(NUMERO) ON DELETE CASCADE
);
